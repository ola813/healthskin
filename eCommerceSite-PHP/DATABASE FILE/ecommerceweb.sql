...
CREATE TABLE `tbl_settings` (
  ...
  `favicon` text(255) NOT NULL,
  `footer_about` text NOT NULL,
  `footer_copyright` text NOT NULL,
  `contact_address` text NOT NULL,
  `contact_email` text(255) NOT NULL,
  `contact_phone` text(255) NOT NULL,
  `contact_fax` text(255) NOT NULL,
  `contact_map_iframe` text NOT NULL,
  `receive_email` text(255) NOT NULL,
  `receive_email_subject` text(255) NOT NULL,
  ...
  `banner_login` text(255) NOT NULL,
  `banner_registration` text(255) NOT NULL,
  `banner_forget_password` text(255) NOT NULL,
  `banner_reset_password` text(255) NOT NULL,
  `banner_search` text(255) NOT NULL,
  `banner_cart` text(255) NOT NULL,
  `banner_checkout` text(255) NOT NULL,
  `banner_product_category` text(255) NOT NULL,
  `banner_blog` text(255) NOT NULL,
  `cta_title` text(255) NOT NULL,
  `cta_content` text NOT NULL,
  `cta_read_more_text` text(255) NOT NULL,
  `cta_read_more_url` text(255) NOT NULL,
  `cta_photo` text(255) NOT NULL,
  `featured_product_title` text(255) NOT NULL,
  `featured_product_subtitle` text(255) NOT NULL,
  `latest_product_title` text(255) NOT NULL,
  `latest_product_subtitle` text(255) NOT NULL,
  `popular_product_title` text(255) NOT NULL,
  `popular_product_subtitle` text(255) NOT NULL,
  `testimonial_title` text(255) NOT NULL,
  `testimonial_subtitle` text(255) NOT NULL,
  `testimonial_photo` text(255) NOT NULL,
  `blog_title` text(255) NOT NULL,
  `blog_subtitle` text(255) NOT NULL,
  `newsletter_text` text NOT NULL,
  `paypal_email` text(255) NOT NULL,
  `stripe_public_key` text(255) NOT NULL,
  `stripe_secret_key` text(255) NOT NULL,
