...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/cust/owl.carousel.min.css">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="css/cust/bootstrap.min.css">
  ...
  <div class="d-md-flex half">
    <div class="bg" style="background-image: url('../assets/img/il_fullxfull.2497922869_m17e.webp');"></div>
    <div class="contents">
		...
		<form action="" method="post">
			<?php $csrf->echoInputField(); ?>
                ...
                <div class=" mb-5 align-items-center">
                  <span class="ml-auto"><a href="registerhtml.php" class="forgot-pass">dont have account ? Sign up</a></span> 
                </div>

                <input type="submit" value="Log In" name="form1" class="btn btn-block btn-primary">
    ...
    <script src="js/cust/jquery-3.3.1.min.js"></script>
    <script src="js/cust/popper.min.js"></script>
    <script src="js/cust/bootstrap.min.js"></script>
