...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['p_link'])) {
        $valid = 0;
        $error_message .= "link can not be empty<br>";
    }
...
foreach ($result as $row) {
	...
	$p_condition = $row['p_advanc'];
	$p_return_policy = $row['p_diadvanc'];
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Risk<br><span style="font-size:10px;font-weight:normal;">(from 0% t0 100%)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_risk" class="form-control" value="<?php echo $p_risk; ?>">
							</div>
						</div>	
				
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Link <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Select risk</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Advantages</label>
							<div class="col-sm-8">
								<textarea name="p_advanc" class="form-control" cols="30" rows="10" id="editor4"><?php echo $p_condition; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Disadvantages</label>
							<div class="col-sm-8">
								<textarea name="p_diadvanc" class="form-control" cols="30" rows="10" id="editor5"><?php echo $p_return_policy; ?></textarea>
							</div>
						</div>
						<div class="form-group">
